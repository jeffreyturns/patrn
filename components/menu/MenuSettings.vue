...
<template>
  ...
  <USlideover v-model="slideover" @close="resetSettings">
    <header class="fixed z-10 flex w-full items-center rounded-tl-2xl border-b dark:border-gray-800 border-gray-200 bg-gray-100/75 p-4 backdrop-blur-sm dark:bg-gray-900/75">
    ...
    <footer class="fixed bottom-0 flex w-full space-x-3 rounded-bl-2xl border-t dark:border-gray-800 border-gray-200 bg-gray-100/75 px-4 py-3.5 backdrop-blur-sm dark:border-gray-800 dark:bg-gray-900/75">
